  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8 bg-cream">
        <h1 className="font-playfair text-2xl font-bold text-charcoal mb-8">Añadir producto</h1>
        <div className="bg-white rounded-xl shadow-sm p-6 max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-charcoal mb-2">Stock inicial</label>
              <input
                name="amount"
                type="number"
                min="0"
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-charcoal/60">Sube una foto desde tu dispositivo (se sube a Cloudinary)</p>
            </div>
